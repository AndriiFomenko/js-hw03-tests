 ...
 *
 * Якщо функція викликається без параметрів, вона не повинна повертати undefined, у цьому випадку потрібно повернути рядок тексту за замовчуванням у верхньому регістрі, тобто defUpperStr() → 'DEFAULT TEXT'.
 *
 * При виконанні завдання не використовуйте оператор if, потрібне рішення з логічним оператором ||.
 */
 ...
 * #4
 *
 * Створіть функцію evenFn(n), яка приймає як параметр число - кількість ітерацій циклу, тобто for 0..n.
 * Функція повинна повернути масив, що складається тільки з парних значень, які генеруються в циклі.
 *
 * Причому:
 * 0 не повинен потрапляти до підсумкового масиву,
 ...
 * #6
 *
 * Створіть функцію ageClassification(n), яка буде як параметр приймати будь-які числа і повертатиме рядок відповідно до таких умов, n:
 ...
 * #7
 *
 * Створіть функцію oddFn(n), яка приймає як параметр число - кількість ітерацій циклу.
 ...
 * a - число,
 * b - число,
 * callback - функція зворотного виклику, що обробляє параметри a і b.
 *
 ...
 * Використовуйте Math для піднесення до степеня (Math.pow) та генерації випадкових чисел (Math.floor, Math.random).
 */

// cbRandom(min, max) - обчислює і повертає довільне ціле число в діапазоні між min і max включно.
// function cbRandom(min, max) { }

// cbPow(num, pow) - обчислює і повертає результат піднесення числа num до степеня pow.
...
/*
 * mainFunc() повинна повертати результат роботи переданої їй функції зворотного виклику, наприклад:
